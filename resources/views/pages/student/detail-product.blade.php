                ...
                <div class="row g-1">
                    <div class="col-md-4">
                        <div class="form-group search-form-group">
                            <input type="text" class="form-control" placeholder="{{ translate('Search by product name, price') }}">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('admin.student.details.course', encrypt_decrypt('encrypt', $user->id)) }}" class="btn-pi">{{ translate('Courses') }}</a>
                    </div>
                </div>
            </div>
        </div>
