                ...
                <div class="row g-1">
                    <div class="col-md-4">
                        <div class="form-group search-form-group">
                            <input type="text" class="form-control" placeholder="Search by course name, Tags Price">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('admin.student.details.product', encrypt_decrypt('encrypt', $user->id)) }}" class="btn-pi">Products</a>
                    </div>
                </div>
            </div>
        </div>
